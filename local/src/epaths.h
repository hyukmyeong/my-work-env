...
*/
#define PATH_LOADSEARCH "/usr/local/share/emacs/28.0.50/lisp"
...
*/
#define PATH_SITELOADSEARCH "/usr/local/share/emacs/28.0.50/site-lisp:/usr/local/share/emacs/site-lisp"
...
*/
#define PATH_DUMPLOADSEARCH "/home/hyuk.myeong/local/./emacs/lisp"
...
#define PATH_EXEC "/usr/local/libexec/emacs/28.0.50/x86_64-pc-linux-gnu"

/* Where Emacs should look for its architecture-independent data
   files, like the NEWS file.  The lisp variable data-directory
   is set to this value.  */
#define PATH_DATA "/usr/local/share/emacs/28.0.50/etc"
...
#define PATH_DOC "/usr/local/share/emacs/28.0.50/etc"
