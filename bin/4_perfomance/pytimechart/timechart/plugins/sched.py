...
"""
    ...
    def do_event_sched_switch(self,event):
        ...
        if event.__dict__.has_key('prev_state') and (event.prev_state == 'R' or event.prev_state =='R+'):# mark prev to be waiting for cpu
            ...
            if event.prev_state == 'R':
                ...
                prev['types'].append(colors.get_color_id("waiting_for_cpu_rplus"))
