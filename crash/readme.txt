1. official web-page -> http://people.redhat.com/anderson
2. build
make target=ARM
make target=ARM extensions
3. caution
extend trace.so : X
extend /home001/hyuk.myeong/bin/6_debugging/crashex/trace.so
4. command
...
#physical offset address : 0x80200000 (cat /proc/iomem 에서 확인)
#Ram size : 0x80000000 
#cpu count : 4 
...
#--no_panic : 시작과 동시에 panic 부분으로 이동하지 않음 - 디버깅할 때는 쓰지 말 것
