...
# MUST start from ~/bin
__REQUIRED_LINKS="arm-linux-androideabi-readelf gen_vmcore_8960"
...
# call gen_vmcore
if [ ! -f vmcore ] ; then
	if [ -f gen_vmcore_8064 ] ; then
		echo ""
		echo "#############################"
		echo "> Build vmcore"
		echo "#############################"
		echo ""
		./gen_vmcore_8064 -p 0x80200000 -z 0x80000000 -e EBICS0.BIN@0x80000000@0x40000000 -e EBI1CS1.BIN@0xC0000000@0x40000000 -n 2
		echo ""
		echo "#############################"
